...
# Population Size Tab (Tab 1)-----------------------------------------------------------  
  ...
  tabPanel("Population size", 
           ...
           fluidRow(
             ...
             # across areas graph - outputID = across_areas_plt_tab_1
             # within areas graph - outputID = within_areas_plt_tab_1
...
# Similar Areas Tab (Tab 2) --------------------------------------------------------------------
  ...
  tabPanel("Comparison of similar areas",
           fluidRow(
             ...
             column(3),
             # Add UiOutput for small area dropdown - outputID = small_area_choice_tab_2
             column(3),
           ...
           fluidRow(
             ...
             # across areas graph - outputID = across_areas_plt_tab_2
             # similar areas graph - outputID = similar_areas_plt_tab_2
